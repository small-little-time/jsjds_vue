    ...
    <el-dialog v-if="works!=null" :title="works.works_name" :visible.sync="detailVisible">
      ...
      <el-dialog
        ...
        <el-form :model="raterForm" label-position="right" label-width="80px">
          ...
          <el-input v-model="raterForm.score" placeholder="请输入分数" style="width:60%;margin-top:10px;"/>
          <el-input v-model="raterForm.comments" placeholder="请输入评语" style="width:60%;margin-top:10px;"/>
          <el-button type="primary" style="margin-top:10px;" @click="updateScore()">提交</el-button>
        </el-form>
      </el-dialog>
...
export default {
  ...
  methods: {
    ...
    getOldScore(works) {
      ...
      this.raterForm.comments = works.comments
    },
    updateScore() {
