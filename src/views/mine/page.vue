<template>
  <el-form ref="form" :model="form" :rules="mineInfoRules" label-width="80px" class="class-form" v-loading="saving">
    ...
    <el-row>
      <el-col :xs="24" :sm="16" :md="16" :lg="12" :xl="10">
        <el-form-item label="学号" class="academy-name">
          <el-input v-model="form.stu_number" disabled ></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :xs="24" :sm="16" :md="16" :lg="12" :xl="10">
        <el-form-item label="二级学院" class="academy-name">
          <el-autocomplete
              ...
              @select="handleAcademySelect" value-key="academy_name" style="width: 100%"
            ></el-autocomplete>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :xs="24" :sm="16" :md="16" :lg="12" :xl="10">
        <el-form-item label="专业" class="academy-name">
          <el-select v-model="form.major_id" placeholder="请先选择学院" style="width: 100%" :disabled="state.major">
            <el-option 
    ...
    <el-form-item>
      <el-button type="primary"  :loading="creating" @click="saveStudent()" >保存</el-button>
