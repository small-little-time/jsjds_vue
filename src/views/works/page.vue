<template>
  <div >
    ...
    <br>
    <br>
    <el-col v-if="tid!=null" style="margin-left:3px;margin-top:20px;" :xs="24" :sm="24" :md="18" :lg="11" :xl="11" >
      <el-form ref="form" :model="form" label-width="80px" :rules="worksRules" class="auth-form" v-loading="teaminfoloading">
        <el-form-item label="作品分类" class="auth-name">
          <el-input disabled :placeholder="this.categoryB"></el-input>
        </el-form-item>
        <el-form-item label="队伍编号" class="auth-name">
          <el-input disabled :placeholder="this.tid"></el-input>
        </el-form-item>
        <el-form-item label="作品名称" class="auth-name" prop="works_name">
          <el-input  v-model="form.works_name"></el-input>
        </el-form-item>
        <el-form-item label="指导老师" class="auth-name" prop="teacher_name">
          <el-input  v-model="form.teacher_name" placeholder="多个请以分号分隔"></el-input>
        </el-form-item>
        ...
        <el-form-item label="作品效果图" class="auth-name" >
          <el-upload 
            action="http://119.23.21.54:10010/upload-service/upload/image"
    ...
    <el-dialog
     ...
     <div v-if="ownTeam.length==0">
      ...
      <el-col  v-else v-for="(team,index) in ownTeam" :key="index"  :xs="24" :sm="24" :md="18" :lg="11" :xl="11" style="margin-right:10px;margin-top:10px;margin-bottom:10px;">
        <el-container  >
            <el-header>
              队伍{{index+1}}
            </el-header>
